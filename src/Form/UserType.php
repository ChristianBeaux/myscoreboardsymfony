    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('email', EmailType::class, [
                ...
                'label' => 'E-mail',
                'constraints' => [
                    new NotNull(['message'=>"Lemail ne peut pas être vide"])
                ]
            ])
            ...
            ->add('password', TextType::class, [
                'mapped' => false,
                'required' => $user->getId() ? false : true // si l'id n'est pas nul, le champs password n'est pas requis (edit) sinon il l'est (new)
